    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 text-center">
        ...
        <div className="relative mx-auto max-w-3xl">
          {/* Eyebrow */}
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/60 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-slate-500">
            <span className="h-1.5 w-1.5 rounded-full bg-cyan-400" />
            Workforce Behaviour Intelligence
          </div>

          {/* Headline */}
          <h1 className="text-5xl font-black leading-[1.02] md:text-[66px]" style={{ letterSpacing: "-0.04em" }}>
          ...
          {/* Sub */}
          <p className="mx-auto mt-7 max-w-xl text-lg text-slate-400 leading-relaxed">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <button
              ...
              className="rounded-2xl bg-gradient-to-r from-cyan-400 to-violet-500 px-9 py-4 text-base font-bold text-slate-950 transition-all hover:scale-[1.02] cursor-pointer border-0"
            >
              Get your free workforce audit
            </button>
            <button
              onClick={() => router.push("/demo")}
              className="rounded-2xl border border-slate-800 px-9 py-4 text-base font-semibold text-slate-400 hover:border-slate-600 hover:text-slate-200 cursor-pointer transition-colors bg-transparent"
            >
              Book a demo →
            </button>
          </div>
      ...
      <section className="border-t border-slate-800/50 px-6 py-20">
        <div className="mx-auto max-w-3xl">
          <p className="mb-10 text-center text-xs font-semibold uppercase tracking-widest text-slate-700">
            ...
            {[
              {
                ...
                desc: "Twelve AI models monitor behavioural signals across your organisation and surface burnout, attrition, and cognitive overload risk before they become visible problems.",
                color: "text-cyan-400",
              },
              {
                n: "02",
              ...
              },
              {
                ...
                desc: "Risk scores, financial exposure estimates, and recommended actions — formatted for leadership decisions, delivered within 48 hours of your audit.",
                color: "text-amber-400",
              },
            ].map((item, i) => (
              <div key={i} className="flex gap-8 py-10">
                <span className={`text-sm font-black flex-shrink-0 mt-1 ${item.color}`}>{item.n}</span>
                <div>
        ...
        <div className="mx-auto max-w-3xl">
          <div className="relative overflow-hidden rounded-3xl border border-slate-800 px-10 py-16 text-center">
            ...
            <div className="relative">
              ...
              <button
                onClick={() => router.push("/diagnostic")}
                className="mt-8 rounded-2xl bg-gradient-to-r from-cyan-400 to-violet-500 px-10 py-4 text-base font-bold text-slate-950 transition-all hover:scale-[1.02] cursor-pointer border-0"
              >
                Get your free workforce audit →
              </button>
